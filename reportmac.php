...
if (isset($_GET['start_date']) && isset($_GET['end_date'])) {
    ...
    try {
        ...
        $sql = "
            ...
            LEFT JOIN operationdetails o ON p.OpnNo = o.OpnNo
                ...
                fetch(`?start_date=${startDate}&end_date=${endDate}`)
                    ...
                    .then(data => {
                        ...
                        data.forEach(item => {
                            ...
                            row.insertCell(1).textContent = item.MachineNo;
                            row.insertCell(2).textContent = item.MachineDescription;
                            row.insertCell(3).textContent = item.DrawingNo;
                            row.insertCell(4).textContent = item.ComponentDescription;
                            row.insertCell(5).textContent = item.OpnNo;
                            row.insertCell(6).textContent = item.OpnName;
                            row.insertCell(7).textContent = item.OpnDesc;
